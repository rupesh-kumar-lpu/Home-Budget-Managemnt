...
public class ExpenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expence3);
        ...
        ((Button)findViewById(R.id.button4)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ed3.matches("")) {
                    Toast.makeText(ExpenceActivity.this, "Enter some value please!", Toast.LENGTH_SHORT).show();
                    ...
                    if (ed2.matches("")) {
                        ...
                        if (Namee.matches("")) {
                            ...
                            if (!(myDatabase.checkEmailAlready(((EditText) findViewById(R.id.editText2)).getText().toString()))) {
                                ...
                                myEdit.commit();
                                Toast.makeText(ExpenceActivity.this,Integer.toString(sharedprefs.getInt("consumed", 0)),Toast.LENGTH_LONG).show();


                                //Toast.makeText(ExpenceActivity.this, "Expence Added Sucessfully!", Toast.LENGTH_SHORT).show();

                            } else {
                                Toast.makeText(ExpenceActivity.this, "Saving Failed! Type alredy exists!", Toast.LENGTH_SHORT).show();
                            }
