...
public class DeleteExpirience extends AppCompatActivity {
    MyBudgetDataBase myDatabase;
    SharedPreferences sharedprefs;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delete_expirience);
        ...
        ((Button)findViewById(R.id.button7)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Namee.matches("")) {
                    Toast.makeText(DeleteExpirience.this, "Enter some value please!", Toast.LENGTH_SHORT).show();
                    ...
                    if ((myDatabase.checkEmailAlready(((EditText) findViewById(R.id.editText5)).getText().toString()))) {
                        ...
                        if (curs.moveToFirst()) // data?{
                        {
                            ...
                            Toast.makeText(DeleteExpirience.this,"Deleted!",Toast.LENGTH_LONG).show();
                        }

                    } else {
                        Toast.makeText(DeleteExpirience.this, "Saving Failed! Type do not exists!", Toast.LENGTH_SHORT).show();
                    }
